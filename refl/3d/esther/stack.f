...
*
* !!! For NSTACK=3,4,5  DIST not yet correct!!!
C--------/---------/---------/---------/---------/---------/---------/--
c >>> nstack,icomp
...
* Decision tree:
      ...
      go to 120
      else if (nstack.eq.13) then      !pyrochlore lattice
      fab=60.d0
      dist=sqrt(6.d0)/6.d0
      go to 130
      end if 
...
130   continue
*
* pyrochlore lattice - alternatingly 3 and 1 particle per plane
*
      DL(1,icomp,1)=(1.d0+cos(pi/3.d0))/12.d0
      DL(2,icomp,1)=(sin(pi/3.d0))/12.d0
      DL(3,icomp,1)=1.d0/(2.d0*sqrt(6.d0))
      if (nplan.gt.1) then 
      do i=2,nplan
      DL(1,icomp,1)=(1.d0+cos(pi/3.d0))/12.d0
      DL(2,icomp,1)=(sin(pi/3.d0))/12.d0
      DL(3,icomp,1)=1.d0/(2.d0*sqrt(6.d0))
      DR(1,icomp,i-1)=(1.d0+cos(pi/3.d0))/12.d0
      DR(2,icomp,i-1)=(sin(pi/3.d0))/12.d0
      DR(3,icomp,i-1)=1.d0/(2.d0*sqrt(6.d0))
      enddo
      end if
      DR(1,icomp,nplan)=(1.d0+cos(pi/3.d0))/12.d0
      DR(2,icomp,nplan)=(sin(pi/3.d0))/12.d0
      DR(3,icomp,nplan)=1.d0/(2.d0*sqrt(6.d0))
      go to 500
***************************************************
140   continue 
*
* pyrochlore lattice - 1 particle per plane
* 3 planes at the same height
*
      DL(1,icomp,1)=1.d0/8.d0
      DL(2,icomp,1)=(sin(pi/3.d0))/4.d0
      DL(3,icomp,1)=0.d0
      DR(1,icomp,1)=1.d0/8.d0
      DR(2,icomp,1)=-(sin(pi/3.d0))/4.d0
      DR(3,icomp,1)=0.d0
      DL(1,icomp,2)=1.d0/8.d0
      DL(2,icomp,2)=-(sin(pi/3.d0))/4.d0
      DL(3,icomp,2)=0.d0
      DR(1,icomp,2)=-1.d0/8.d0
      DR(2,icomp,2)=(sin(pi/3.d0))/12.d0
      DR(3,icomp,2)=1.d0/(6.d0*sqrt(6.d0))
      DL(1,icomp,3)=-1.d0/8.d0
      DL(2,icomp,3)=(sin(pi/3.d0))/12.d0
      DL(3,icomp,3)=1.d0/(6.d0*sqrt(6.d0))
      DR(1,icomp,3)=1.d0/8.d0
      DR(2,icomp,3)=(sin(pi/3.d0))/12.d0
      DR(3,icomp,3)=1.d0/(6.d0*sqrt(6.d0))
      DL(1,icomp,4)=1.d0/8.d0
      DL(2,icomp,4)=(sin(pi/3.d0))/12.d0
      DL(3,icomp,4)=1.d0/(6.d0*sqrt(6.d0))
      DR(1,icomp,4)=1.d0/8.d0
      DR(2,icomp,4)=(sin(pi/3.d0))/4.d0
      DR(3,icomp,4)=0.d0
      DL(1,icomp,5)=1.d0/8.d0
      DL(2,icomp,5)=(sin(pi/3.d0))/4.d0
      DL(3,icomp,5)=0.d0
      DR(1,icomp,5)=1.d0/8.d0
      DR(2,icomp,5)=-(sin(pi/3.d0))/4.d0
      DR(3,icomp,5)=0.d0
      DL(1,icomp,6)=1.d0/8.d0
      DL(2,icomp,6)=-(sin(pi/3.d0))/4.d0
      DL(3,icomp,6)=0.d0
      DR(1,icomp,6)=-1.d0/8.d0
      DR(2,icomp,6)=(sin(pi/3.d0))/12.d0
      DR(3,icomp,6)=1.d0/(6.d0*sqrt(6.d0))
      DL(1,icomp,7)=-1.d0/8.d0
      DL(2,icomp,7)=(sin(pi/3.d0))/12.d0
      DL(3,icomp,7)=1.d0/(6.d0*sqrt(6.d0))
      DR(1,icomp,7)=1.d0/8.d0
      DR(2,icomp,7)=(sin(pi/3.d0))/12.d0
      DR(3,icomp,7)=1.d0/(6.d0*sqrt(6.d0))
      DL(1,icomp,8)=1.d0/8.d0
      DL(2,icomp,8)=(sin(pi/3.d0))/12.d0
      DL(3,icomp,8)=1.d0/(6.d0*sqrt(6.d0))
      DR(1,icomp,8)=1.d0/8.d0
      DR(2,icomp,8)=(sin(pi/3.d0))/4.d0
      DR(3,icomp,8)=0.d0
      DL(1,icomp,9)=1.d0/8.d0
      DL(2,icomp,9)=(sin(pi/3.d0))/4.d0
      DL(3,icomp,9)=0.d0
      DR(1,icomp,9)=1.d0/8.d0
      DR(2,icomp,9)=-(sin(pi/3.d0))/4.d0
      DR(3,icomp,9)=0.d0
      DL(1,icomp,10)=1.d0/8.d0
      DL(2,icomp,10)=-(sin(pi/3.d0))/4.d0
      DL(3,icomp,10)=0.d0
      DR(1,icomp,10)=-1.d0/8.d0
      DR(2,icomp,10)=(sin(pi/3.d0))/12.d0
      DR(3,icomp,10)=1.d0/(6.d0*sqrt(6.d0))
      DL(1,icomp,11)=-1.d0/8.d0
      DL(2,icomp,11)=(sin(pi/3.d0))/12.d0
      DL(3,icomp,11)=1.d0/(6.d0*sqrt(6.d0))
      DR(1,icomp,11)=1.d0/8.d0
      DR(2,icomp,11)=(sin(pi/3.d0))/12.d0
      DR(3,icomp,11)=1.d0/(6.d0*sqrt(6.d0))
      DL(1,icomp,12)=1.d0/8.d0
      DL(2,icomp,12)=(sin(pi/3.d0))/12.d0
      DL(3,icomp,12)=1.d0/(6.d0*sqrt(6.d0))
      DR(1,icomp,12)=1.d0/8.d0
      DR(2,icomp,12)=(sin(pi/3.d0))/4.d0
      DR(3,icomp,12)=0.d0
      go to 500
******************************************************
 500  continue
