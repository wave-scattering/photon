...
C--------/---------/---------/---------/---------/---------/---------/--                                                                           
      ...
      character*1 yntest
*
      parameter (LMAXD=8,LMAX1D=LMAXD+1,laytm=1,natlm=3)
...
cx      else
*
* Array initialization to zero - zeroing a complex matrix with
* a real subroutine - hence factor 2 here:
*
