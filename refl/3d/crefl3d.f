...
c      rmuf= 0.481186509d0                        !f_{fcc}=0.66
      rmuf=sqrt(6.d0)/8.d0                        !cp diamond 
...
C======================================================================= 
*  OUTPUT WRITING 
      OPEN(UNIT=NOUT,FILE='rctacp.dat')
      rewind(NOUT)
...
***********************************************************************      
      ...
      OPEN(UNIT=40,FILE='rflphcpdmd8eps20-2ucA.dat')
      rewind(40)
